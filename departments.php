    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row d-flex">
    			...
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
    					<a href="department-single.php" class="img" style="background-image: url(images/dept-2.jpg);"></a>
    					<div class="text p-4">
    						<h3><a href="department-single.php">Surgical Department</a></h3>
    						<p><span class="loc">203 Fake St. California, USA</span></p>
    						<p><span class="doc">22 Doctors</span></p>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
    						<ul>
    			...
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
    					<a href="department-single.php" class="img" style="background-image: url(images/dept-3.jpg);"></a>
    					<div class="text p-4">
    						<h3><a href="department-single.php">Neurological Department</a></h3>
    						<p><span class="loc">203 Fake St. California, USA</span></p>
    						<p><span class="doc">22 Doctors</span></p>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
    						<ul>
    			...
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
    					<a href="department-single.php" class="img" style="background-image: url(images/dept-4.jpg);"></a>
    					<div class="text p-4">
    						<h3><a href="department-single.php">Ophthalmological Department</a></h3>
    						<p><span class="loc">203 Fake St. California, USA</span></p>
    						<p><span class="doc">22 Doctors</span></p>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
    						<ul>
